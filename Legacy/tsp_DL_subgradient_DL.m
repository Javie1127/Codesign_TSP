function [DLcomm, radar_DL, cov_DL] = tsp_DL_subgradient_DL(DLcomm, radar_comm_DL, radar_DL, cov_DL, jj, k)
...
%     R_jd_k_t = log2(det((E_jd_k_t)^(-1)));
    ...
    cov_DL_temp = tsp_covmat_DL(DLcomm_temp, radar_DL, radar_comm_DL);
