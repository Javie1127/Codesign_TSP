...
load('tsp_UL_SNR_new.mat','I_total','I_total_radar','I_total_DL','I_total_FD','I_total_UL');
...
I_total_UL_avg = mean(I_I_total_UL_new,2);
I_total_DL_avg = mean(I_I_total_DL_new,2);
...
% end
plot(UL_SNR_sweep, I_total,'m--o','LineWidth',1.5)
hold on
plot(UL_SNR_sweep, I_total_radar,'r-+','LineWidth',1.5)
hold on
plot(UL_SNR_sweep, I_total_FD,'g:*','LineWidth',1.5)
hold on
plot(UL_SNR_sweep, I_total_UL,'k-.x','LineWidth',1.5)
hold on
plot(UL_SNR_sweep, I_total_DL,'b:^','LineWidth',1.5)
hold off
grid on
axis square
