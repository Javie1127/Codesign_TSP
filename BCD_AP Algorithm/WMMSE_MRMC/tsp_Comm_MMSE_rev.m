...
for k = 1:K
    for jj = 1 : J
        ...
        E_dj_k_star = nearestSPD(eye(fdcomm.DLstream_num(jj))-nearestSPD(P_dj_k'*HBj'/R_DL_j_k*HBj*P_dj_k));
...
for k = 1:K
    ...
    for ii = 1 : I
        ...
        E_ui_k_star = nearestSPD(eye(fdcomm.ULstream_num(ii))- nearestSPD(P_ui_k'*HiB'/R_UL_i_k*HiB*P_ui_k));
