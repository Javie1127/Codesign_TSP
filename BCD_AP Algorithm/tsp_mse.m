...
for ii = 1 : I
    ...
    fdcomm.UL_MMSE{ii,k} = eye(fdcomm.ULstream_num(ii))- (P_ui_k'*HiB'/R_UL_i_k*HiB*P_ui_k);
    fdcomm.UL_MMSE_nop{ii,k} = eye(fdcomm.ULstream_num(ii))-2*U_ui_k*HiB*P_ui_k + (U_ui_k*R_in_i_k*U_ui_k');
end
for jj = 1 : J
    ...
    fdcomm.DL_MMSE{jj,k} = eye(fdcomm.DLstream_num(jj))- (P_dj_k'*HBj'/R_DL_j_k*HBj*P_dj_k);
