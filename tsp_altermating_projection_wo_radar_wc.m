function [fdcomm_op, radar_op,cov_op, radar_ini] = tsp_altermating_projection_wo_radar_wc...
...
while ell <= ell_max
    [fdcomm, radar] =...
        tsp_WMMSE_algorithm_multimode_wc(fdcomm, radar, radar_comm, cov,'radar');
    % Calculate A^star
...
cov_op = tsp_covmat_wc(fdcomm_op,radar_op,radar_comm);
end
